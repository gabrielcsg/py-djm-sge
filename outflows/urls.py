...
urlpatterns = [
    ...
    path('api/v1/outflows/', views.OutflowListCreateAPIView.as_view(), name='outflow_list_create_api'),
    path('api/v1/outflows/<int:pk>/', views.OutflowRetrieveAPIView.as_view(), name='outflow_retrieve_api'),
]
